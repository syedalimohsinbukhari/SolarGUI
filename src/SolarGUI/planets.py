...
class Mercury(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Mercury().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Mercury().OrbitalParameters, self).__init__(
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Mercury().ObservationalParameters, self).__init__(
                dist_from_earth=d_,
                ap_mag_min=7.25,
                ap_mag_max=-2.48,
                geom_albedo=0.138,
...
class Venus(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Venus().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Venus().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Venus().ObservationalParameters, self).__init__(
                dist_from_earth=d_,
                ap_mag_min=-2.98,
                ap_mag_max=-4.92,
                geom_albedo=0.689,
...
class Earth(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Earth().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Earth().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
...
class Mars(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Mars().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Mars().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Mars().ObservationalParameters, self).__init__(
                dist_from_earth=d_,
                ap_mag_min=1.86,
                ap_mag_max=-2.94,
                geom_albedo=0.17,
...
class Jupiter(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Jupiter().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Jupiter().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
                orbital_period=t_orb,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Jupiter().ObservationalParameters, self).__init__(
                dist_from_earth=d_,
                ap_mag_min=-1.66,
                ap_mag_max=-2.94,
                geom_albedo=0.538,
...
class Saturn(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Saturn().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Saturn().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
                orbital_period=t_orb,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Saturn().ObservationalParameters, self).__init__(
                dist_from_earth=d_,
                ap_mag_min=1.17,
                ap_mag_max=-0.55,
                geom_albedo=0.499,
...
class Uranus(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Uranus().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Uranus().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
                orbital_period=t_orb,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Uranus().ObservationalParameters, self).__init__(
                dist_from_earth=d_,
                ap_mag_min=6.03,
                ap_mag_max=5.38,
                geom_albedo=0.488,
...
class Neptune(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Neptune().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Neptune().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
                orbital_period=t_orb,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Neptune().ObservationalParameters, self).__init__(
                dist_from_earth=d_, ap_mag_min=8, ap_mag_max=7.67, geom_albedo=0.442, ang_min=ang_min, ang_max=ang_max
            )
