...
class Moon(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Moon().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Moon().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Moon().ObservationalParameters, self).__init__(
                dist_from_earth=d_,
                ap_mag_min=-2.5,
                ap_mag_max=-12.9,
                geom_albedo=0.136,
...
class Phobos(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Phobos().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Phobos().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Phobos().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=11.8, geom_albedo=0.071, ang_min=ang_min, ang_max=ang_max
            )
...
class Deimos(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Deimos().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Deimos().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Deimos().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=12.89, geom_albedo=0.068, av_ang_size=av_
            )
...
class Io(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Io.PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Io().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Io().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=5.02, geom_albedo=0.63, av_ang_size=av_
            )
...
class Europa(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Europa().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Europa().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Europa().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=5.29, geom_albedo=0.67
            )
...
class Ganymede(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Ganymede().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Ganymede().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Ganymede().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=4.61, geom_albedo=0.43, ang_min=ang_min, ang_max=ang_max
            )
...
class Callisto(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Callisto().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Callisto().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Callisto().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=5.65, geom_albedo=0.22
            )
...
class Metis(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Metis().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Metis().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Metis().ObservationalParameters, self).__init__(dist_from_earth=d_, geom_albedo=0.061)
...
class Adrastea(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Adrastea().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Adrastea().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Adrastea().ObservationalParameters, self).__init__(dist_from_earth=d_, geom_albedo=0.1)
...
class Amalthea(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Amalthea().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Amalthea().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Amalthea().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=14.1, geom_albedo=0.09
            )
...
class Thebe(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Thebe().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Thebe().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Thebe().ObservationalParameters, self).__init__(dist_from_earth=d_, geom_albedo=0.047)
...
class Mimas(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Mimas().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Mimas().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Mimas().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=12.9, geom_albedo=0.962
            )
...
class Enceladus(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Enceladus().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Enceladus().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Enceladus().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=11.7, geom_albedo=1.375
            )
...
class Tethys(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Tethys().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Tethys().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Tethys().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=10.2, geom_albedo=1.229
            )
...
class Dione(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Dione().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Dione().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Dione().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=10.4, geom_albedo=0.998
            )
...
class Rhea(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Rhea().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Rhea().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Rhea().ObservationalParameters, self).__init__(dist_from_earth=d_, apparent_mag=10, geom_albedo=0.949)
...
class Titan(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Titan().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Titan().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Titan().ObservationalParameters, self).__init__(
                dist_from_earth=d_, ap_mag_min=9, ap_mag_max=8.2, geom_albedo=0.949
            )
...
class Hyperion(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Hyperion().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Hyperion().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis, ecc=self.eccentricity, orbital_period=21.276, inclination=0.43
            )
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Hyperion().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=14.1, geom_albedo=0.949
            )
...
class Iapetus(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Iapetus().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Iapetus().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Iapetus().ObservationalParameters, self).__init__(
                dist_from_earth=d_, ap_mag_min=11.9, ap_mag_max=10.2, geom_albedo=0.949
            )
...
class Miranda(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Miranda().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Miranda().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Miranda().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=15.8, geom_albedo=0.32
            )
...
class Umbriel(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Umbriel().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Umbriel().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Umbriel().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=14.5, geom_albedo=0.26
            )
...
class Ariel(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Ariel().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Ariel().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Ariel().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=14.4, geom_albedo=0.53
            )
...
class Titania(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Titania().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Titania().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Titania().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=13.9, geom_albedo=0.35
            )
...
class Oberon(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Oberon().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Oberon().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Oberon().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=14.1, geom_albedo=0.31
            )
...
class Naiad(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Naiad().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Naiad().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Naiad().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=23.91, geom_albedo=0.072
            )
...
class Thalassa(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Thalassa().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Thalassa().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Thalassa().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=23.32, geom_albedo=0.091
            )
...
class Despina(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Despina().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Despina().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Despina().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=22.0, geom_albedo=0.09
            )
...
class Galatea(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Galatea().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Galatea().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Galatea().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=21.9, geom_albedo=0.08
            )
...
class Larissa(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Larissa().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Larissa().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Larissa().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=21.5, geom_albedo=0.09
            )
...
class Hippocamp(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Hippocamp().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Hippocamp().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
                orbital_period=0.95,
                mean_anom=329.901,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Hippocamp().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=26.5, geom_albedo=0.09
            )
...
class Proteus(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Proteus().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Proteus().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Proteus().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=19.7, geom_albedo=0.096
            )
...
class Triton(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Triton().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Triton().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Triton().ObservationalParameters, self).__init__(
                dist_from_earth=d_,
                apparent_mag=13.47,
                # absolute_mag=-1.2,
                geom_albedo=0.76,
...
class Charon(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Charon().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Charon().OrbitalParameters, self).__init__(
                a_0=self.semi_major_axis,
                ecc=self.eccentricity,
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Charon().ObservationalParameters, self).__init__(
                dist_from_earth=d_,
                av_ang_size=av_,
                apparent_mag=16.8,
                # absolute_mag=1,
