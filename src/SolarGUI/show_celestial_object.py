...
class GetParameterSelection:
    """The GetParameterSelection class holds the button for Physical, Orbital, Observational parameter and more."""

    def __init__(self, window: Union[tk.Tk, tk.Toplevel, tk.Frame], object_name: str, object_class: Any):
        ...
        self.phy = tk.Button(
            ...
            command=lambda: show_physical_parameters(window=self.parameter_frame, object_class=object_class),
        )
        ...
        if object_name != "Sun":
            self.orb = tk.Button(
                ...
                command=lambda: show_orbital_parameters(
                    window=self.parameter_frame, object_name=object_name, object_class=object_class
                ),
            )
...
def show_physical_parameters(window: Union[tk.Tk, tk.Toplevel, tk.Frame], object_class: Any):
    ...
    # heading labels
    tk_functions.label_placement(window=planet_window, text="Physical parameters", row=0, column=0, pad_y=5, sticky="e")
    tk_functions.label_placement(window=planet_window, text="Values", row=0, column=1, pad_y=5)
    tk_functions.label_placement(window=planet_window, text="Unit space", row=0, column=2, pad_y=5)
    ...
    tk_functions.object_button(
        ...
        function=lambda: tk_functions.place_equivalencies(
            window=planet_window, cel_object=object_class, equiv_type="physical", column=4
        ),
        text="Equivalences",
        row=0,
        column=4,
    ...
    tk_functions.place_object_properties(
        ...
        function=utilities.convert,
        text="Volume",
        value=object_class.volume,
        row=4,
        column=0,
        options=("cm^3", "m^3", "km^3"),
        default="km^3",
    )
    ...
    tk_functions.place_object_properties(
        ...
        function=utilities.convert,
        text="Surface area",
        value=object_class.surface_area,
        row=6,
        column=0,
        options=("cm^2", "m^2", "km^2"),
        default="km^2",
    )
    ...
    tk_functions.place_object_properties(
        ...
        value=object_class.surface_gravity,
        row=7,
        column=0,
        options=("cm/s^2", "m/s^2", "km/s^2"),
        default="m/s^2",
    )
    ...
    tk_functions.place_object_properties(
        ...
        value=object_class.escape_velocity,
        row=8,
        column=0,
        options=("cm/s", "m/s", "km/s", "km/h"),
        default="km/s",
    )


def show_orbital_parameters(window: Union[tk.Tk, tk.Toplevel, tk.Frame], object_name: str, object_class: Any):
    ...
    # heading labels
    tk_functions.label_placement(window=planet_window, text="Orbital parameters", row=0, column=0, pad_y=5, sticky="e")

    if object_name in planet_moon.keys():
        tk_functions.label_placement(
            window=planet_window,
            text="The orbital parameters are given with respect to the planet " "{planet_moon[object_name]}.",
            row=20,
            column=0,
            columnspan=10,
            pad_y=10,
    ...
    tk_functions.object_button(
        window=planet_window,
        function=lambda: tk_functions.place_equivalencies(
            window=planet_window, cel_object=object_class, equiv_type="orbital", column=4
        ),
        text="Equivalences",
        row=0,
        column=4,
    ...
    tk_functions.place_object_properties(
        window=planet_window,
        function=utilities.convert,
        text="Farthest approach",
        value=object_class.peri,
        row=4,
        column=0,
        options=("cm", "m", "km", "Gm", "AU", "lyr", "pc"),
        default="AU",
    ...
    tk_functions.place_object_properties(
        ...
        function=utilities.convert,
        text="Mean anomaly",
        value=object_class.mean_anomaly,
        row=7,
        column=0,
        options=anom_[0],
        default=anom_[1],
    ...
    tk_functions.place_object_properties(
        ...
        function=utilities.convert,
        text="Inclination",
        value=object_class.inclination,
        row=8,
        column=0,
        options=incl_[0],
        default=incl_[1],
...
def show_observational_parameters(window: Union[tk.Tk, tk.Toplevel, tk.Frame], object_name: str, object_class: Any):
    """Display the orbital parameters of the celestial object.
    ...
    # heading labels
    tk_functions.label_placement(
        window=planet_window, text="Observational parameters", row=0, column=0, pad_y=5, sticky="e"
    )
    ...
    tk_functions.object_button(
        window=planet_window,
        function=lambda: tk_functions.place_equivalencies(
            window=planet_window, cel_object=object_class, equiv_type="observation", column=4
        ),
        text="Equivalences",
        row=0,
        column=4,
    ...
    if object_name not in star_list:
        if object_name in planet_list:
            text = "Distance from Earth for the planet is calculated as the planets' distance from Sun in AU - 1 AU."
        elif object_name in moon_list and object_name != "Moon":
            _pl_name = [moon for moon, planet in planet_moon.items() if moon == object_name][0]
            text = (
                f"Distance from Earth to {_pl_name} is taken as the distance from Earth to the parent planet, "
                f"e.g, {planet_moon[object_name]}."
            )
        else:
            text = ""

        tk_functions.label_placement(window=planet_window, text=text, row=20, columnspan=10, pad_y=10, sticky="news")
