...
class Sun(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Sun().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Sun().ObservationalParameters, self).__init__(
                dist_from_earth=d_, apparent_mag=-26.74, geom_albedo=0.0001, ang_min=ang_min, ang_max=ang_max
            )
