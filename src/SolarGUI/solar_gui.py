    ...
    def __init__(self):
        ...
        tk_f.object_button(window=self.moons_frame, text='Charon',
                           function=lambda: sco.GetParameterSelection(
                                   ...
                                   object_class=moons_.Europa), row=7, column=1)
