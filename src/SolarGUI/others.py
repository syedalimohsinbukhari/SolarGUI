...
class Pluto(_CelestialObject.c_):
    ...
    class PhysicalParameters(_CelestialObject.c_phy):
        ...
        def __init__(self):
            ...
            super(Pluto().PhysicalParameters, self).__init__(mass=self.mass, radius=self.radius)
    ...
    class OrbitalParameters(_CelestialObject.c_orb):
        ...
        def __init__(self):
            ...
            super(Pluto().OrbitalParameters, self).__init__(
    ...
    class ObservationalParameters(_CelestialObject.c_obs):
        ...
        def __init__(self):
            ...
            super(Pluto().ObservationalParameters, self).__init__(
                dist_from_earth=d_,
                ap_mag_min=16.3,
                ap_mag_max=13.65,
                geom_albedo=0.52,
